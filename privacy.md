...
This page is the long-form version of that rule.
...
- No account, no email, no password — Pace does not have user accounts.
...
- No location tracking. The Safety tab can open Apple Maps to your home address, but Pace itself does not store, transmit, or share your GPS coordinates.

---

## Deleting your data

Delete the Pace app from your iPhone. Everything is gone. There is no backup on our side — because there is no "our side."
...
If this policy changes, you will see a notice in the app on next launch summarizing what changed. You are then free to delete the app if you no longer agree.
