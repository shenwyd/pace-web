    ...
    <div class="shell">
      <div class="values reveal-stagger">
        <div class="value-card">
          ...
          <p>Once a night, Pace pings you to capture your night with both cameras at once — your face and what's in front of you. No filters, no highlight reel.</p>
        </div>
        <div class="value-card">
          <div class="icon sober">✓</div>
          <h3>Friends who look out</h3>
          <p>Share with your people and react to theirs. The point isn't likes — it's knowing your friends saw your night, and you saw theirs.</p>
        </div>
        <div class="value-card">
    ...
    <div class="shell">
      <div class="feature reveal">
        <div>
          ...
          <p>Sometime after things get going, Pace sends one prompt. You have a moment to capture your night with the front and back camera together — then share it with friends or, if you want, publicly.</p>
          <ul>
            <li>One nightly prompt — no endless posting, no pressure</li>
            <li>Dual-camera capture: your face and the room, at once</li>
            <li>Share with friends, or go public if you choose</li>
            <li>React to your friends' nights with an emoji tap</li>
          </ul>
        </div>
        <div class="hero-art">
          <div class="phone">
    ...
    <div class="shell">
      <div class="feature reveal">
        <div>
          ...
          <p>Posts are ephemeral — they disappear after 24 hours. No permanent record, no archive to live down. You decide who sees your night, and it doesn't outlast it.</p>
          <ul>
            <li>Every post vanishes 24 hours after you share it</li>
            <li>Public or private profile — your call, change it anytime</li>
            <li>You pick who's in your circle and who sees what</li>
            <li>Your drink log stays on your device, just for you</li>
          </ul>
        </div>
        <div class="hero-art">
          <div class="phone">
      ...
      <div class="privacy-block reveal">
        ...
        <div class="privacy-grid reveal-stagger">
          ...
          <div>
            ...
            <span>Set your profile either way, and switch whenever you want.</span>
          </div>
          <div>
            <strong>Your circle, your call</strong>
  ...
  <section>
    <div class="shell">
      <div class="cta-strip reveal">
        ...
        <a href="mailto:{{ site.email }}" class="btn btn-primary">Email {{ site.email }}</a>
      </div>
    </div>
  </section>
